...
$url        = 'https://github.com/qishibo/AnotherRedisDesktopManager/releases/download/v1.5.6/Another-Redis-Desktop-Manager.1.5.6.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'Another Redis Desktop Manager*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided.
  # You can also use checksum.exe (choco install checksum) and use it
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = 'AngrcmehkuOAP8jcLqltnC2v9snyoyMy8U7Y849argsXdDx8l3OYTfupebF3t64IxaXM0FUhMT9Y18ONHuO8Lw=='
